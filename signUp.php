        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-center vh-100">
                <div class="signup-container">
                    <h1 style="color: #7c20c1;" class="mb-4 text-center fw-bold">Join Us!</h1>
                    ...
                    <form>
                        ...
                        <a type="button" href="index.php" class="btn btn-primary signupBtn">Sign Up</a>
                        <h6 class="mt-3 mb-0 text-center">Already have an account? <a href="signIn.php">Sign In</a></h6>
                    </form>
                </div>
            </div>
        </div>
